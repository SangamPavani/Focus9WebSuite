...
public static String checkValidationMessage(String ExpMessage) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	...
	private static WebElement  budgetPlanningTagSelection;
...
*/	}
		...
		if(actAlertMgs.equalsIgnoreCase(expAlertMgs) && actMessage.equalsIgnoreCase(expMessage))
  {
	...
	@FindBy(xpath="//*[@id='dvInfo']/div//label")
	 ...
	 /* @FindBy(xpath="//*[@id='GenerateNewMasterModel']/div/div[2]/div[3]/div[2]/div/ul/li[2]/button[2]")
	  ...
	  public boolean checkSaveVATAccountsInPreferences() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	  {
		...
		public boolean checkWarehouseMangementInPreferences() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			int expwarehouseMangementListCount=33;
			...
			String expwarehouseMangement="[Sales return note, Returns, Mobile app Stock check alert template, Default bin(location)for receiving, Default bin(location)for shipping, Default Status, Allow changing the bin in mobile app, Allow skid, Apply auto allocate in bin stategy, Skid is optional, Allow Movement Of Reserved Stock, Prefix the customer code to the product code, Enable Batch-wise scanning, Hide the values of the service charges in RTS & Dispatch Confirmation, Enable barcode scanning for Expiry date and manufacturing date, Allow changing bin2 in put away confirmation, Do not display Item voucher Quantity in the scanning page, Item scanning mandatory for every Quantity, Exact Quantity check in RTS, Allow same skid, Allow verify LOT, Print RTS, Skid nomenclature, Auto release picklist(days) before ship date, Reservation Policy, Priority, Default Receipt Method, Status change document, Many to one move document, One to many document, Shortage of stock document, Excess of stock document, Posting Bill]";
		...
		public boolean checkLetterForCreditInPreferences() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			int expletterOFCreditListCount=11;
		...
		public boolean checkPronghornInPreferences() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			if(enableProghornChkbox.isSelected()==false)
			{
		...
		public boolean checkSavedOptionsInPreferences() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
	        ...
	        getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(ReservationByRMAChkBox));
            boolean actIncludeReserveStockInStockCheckChkBox=IncludeReserveStockInStockCheckChkBox.isSelected();
