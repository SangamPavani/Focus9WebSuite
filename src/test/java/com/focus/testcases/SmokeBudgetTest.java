...
public class SmokeBudgetTest extends BaseEngine
{
   ...
   // TRANSFER BUDGET
	...
	@Test(priority=100061)
	 ...
	 public void checkLogoutTheCompany() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
			sbp=new SmokeBudgetPage(getDriver());		
			Assert.assertEquals(sbp.checkLogoutTheCompany(), true);	
	 }
